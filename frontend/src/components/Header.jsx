...
function Header({ currentLevel = 1, totalLevels = 10, totalScore = 0 }) {
  return (
    <div className='w-full min-h-[5.5rem] bg-[#4860bd] border-b border-gray-200 flex items-center justify-between px-2 sm:px-4 gap-2'>
      ...
      <div className='flex items-center gap-2 sm:gap-3 mr-1 sm:mr-3 shrink-0'>
        ...
        <FaQuestionCircle className='text-white text-xl sm:text-2xl cursor-pointer hover:text-gray-300 transition-all duration-300 hidden sm:block' />
      </div>
    </div>
  )
}
